...
function randomColor() {
    ...
    quote.innerHTML = '<i class="bi bi-quote icon"></i>' + " " + quotes[number].quoteText;
    if (quotes[number].quoteAuthor == '') {
        person.innerText = '- ' + "Guy Cohen"
    } else {
        person.innerText = '- ' + quotes[number].quoteAuthor;
    }
};
